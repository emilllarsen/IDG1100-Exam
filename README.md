...
3: Inside the terminal type out: sudo nano /etc/apache2/sites-available/weatherguessinggame.conf
 - Inside here copy everything in the /conf/weatherguessinggame.conf file and paste it in.

4: In terminal type out sudo nano /etc/hosts
 - Inside hosts file copy this: 127.0.0.1   weatherguessinggame.com 

5: inside terminal type this out: 
 - sudo a2ensite weatherguessinggame.conf
 - sudo systemctl reload apache2
 - sudo a2enmod cgi
 - sudo systemctl restart apache2

6: Play the game in your browser at www.weatherguessinggame.com.
